#ifndef EXAMPLE_4_H2GRI_NAVIER_STOKES_EQUATIONS_VIA_METHOD_OF_LINES_HH
#define EXAMPLE_4_H2GRI_NAVIER_STOKES_EQUATIONS_VIA_METHOD_OF_LINES_HH
/**
...
namespace Adonis{
  ...
  public:
    ...
    typedef ThermoData4Mechanism<BaseType,9> DataType;  
    ...
    typedef StaticArray<T,9> ArrayType; 
    ...
    H2GriReactiveNS2D(SizeType dim = 0):rhs_(dim){
      ...
      T bdfuel[] = {0.,0.,0.,0.,1.,0.,0.,0.,0.};
      T bdoxi[] =  {0.,0.232,0.,0.,0.,0.,0.,0.,0.768};
	...
	bdyOxi_[k] = bdoxi[k];
      ...
      T air[] = { PD.get_datum<double>("O"),    //0.,
		  PD.get_datum<double>("O2"),   //0.21,   //0.21
		  PD.get_datum<double>("H"),    //0.,
		  PD.get_datum<double>("OH"),   //0.,
		  PD.get_datum<double>("H2"),    //0.,
		  PD.get_datum<double>("HO2"),   //0.
		  PD.get_datum<double>("H2O2"),     //0.,
		  PD.get_datum<double>("H2O"),      //0.01,   //0.01
	...
	for(int j = 1; j < ny_-1; ++j){
	  ...
	  preserve_mass(H2,i,j,u_);   //do it for first argument
